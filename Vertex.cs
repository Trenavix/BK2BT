...
public struct Vertex
{
    ...
    {
        return new Vector2(U / (0x40) / Textures.S_Scale * U_Scale, V / (0x40) / Textures.T_Scale * V_Scale);
    }
    ...
    public static double[][] UVChecker(double[][] UVs, out bool isFailedToResize)
    {
        ...
        while (reoccur)
        {
            ...
            catch (Exception)
            {
                ...
                DialogResult Continue = MessageBox.Show("UV Coordinates for this size out of range! Reverting...", "UVs out of range", MessageBoxButtons.OK);
                return UVs;
            }
        }
